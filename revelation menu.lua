...
local script do
    ...
    script.user = 'telegram @holyskeet'

    local allowed_user = "telegram @holyskeet"
    if script.user ~= allowed_user then
        print("" .. allowed_user)
        return
    end
    print("Подпишись на телеграм @HOLYSKEET что бы не пропустить новые версии ")
end
        ...
        local miscellaneous = { } do
            ...
            local trash_talk = { } do
                ...
                trash_talk.tooltip = menu.new(
                    ui.new_label, 'AA', 'Anti-aimbot angles', 'FIXED BY TGK @holyskeet'
                )
    ...
    local miscellaneous do
        ...
        local trash_talk do
            ...
            local MESSAGES = {
                ['On Kill'] = {
                    {
                        { 'η ᲼σ ᲼ӷ ᲼σ ᲼∂᲼ υ ᲼. ᲼. ᲼. ᲼. ᲼ ʜ᲼ ϱ ᲼ ᲼ ɞ᲼ с ᲼τ ᲼α ᲼ɞ᲼ α᲼ ύ', 2.50 },
                    },

                    {
                        { 'Д̷о̷б̷р̷о̷ ̷п̷о̷ж̷а̷л̷о̷в̷а̷т̷ь̷ ̷н̷а̷ ̷с̷е̷р̷в̷е̷р̷ ̷Б̷Е̷З̷У̷М̷Н̷Ы̷Е̷ ̷З̷О̷М̷Б̷И̷', 1.80 },
                    },

                    {
                        { 'ҠÅЙႴ᲼᲼ ҠÅЙႴ᲼᲼ ◔◡◔ ᲼᲼ҠÅЙႴ ᲼᲼ОＴ ᲼᲼ДẎᗯИ ᲼᲼ҠÅЙႴОℬÅＴｂ᲼᲼ ✘ОӴẎ᲼᲼ СẎҠÅ', 1.37 },
                    },

                    {
                        { 'че тварь умерла опять?', 2.50 },
                    },

                    {
                        { 'дыʍ дыʍ, ᴋᴀзино и бᴧяди', 2.2 },
                    },

                    {
                        { 'Как вывести голду с GGDROP? Туториал!', 1.8 },
                    },


                    {
                        { 'ɴᴏ ᴀᴇsᴛʜᴇᴛɪᴄ ʟᴜᴀ ɴᴏ ᴛᴀʟᴋɪɴɢ (◣_◢)', 2.1 },
                    },

                    {
                        { '◣_◢ 𝕐𝕠𝕦 𝕒𝕨𝕒𝕝𝕝 𝕗𝕚𝕣𝕤𝕥? 𝕆𝕜 𝕝𝕖𝕥𝕤 𝕗𝕦𝕟 🙂', 2.1 },
                    },
                    ...
                    {
                        { 'ПРИТВОРИЛСЯ НУБОМ И ЗАТРОЛЛИЛ АГРО СТРИМЕРШУ ЧИТАМИ В Standoff 2', 2.8 }
                    },

                    {
                        { 'Здарова педик!', 1 },
                        { 'Лежи кайфуй, чмошник!', 1.9 }
                    },

                    {
                        { 'ПОЗВОНИЛ ПО НОМЕРУ БОМБЫ ИЗ Standoff 2', 2.3 },
                    },

                    {
                        { 'ты точно игрок?', 1.9 },
                        { 'а то играешь хуево', 2.6 }
                    },
                    ...
                    {
                        { 'дʏʍᴀᴇшь ᴛʙᴏи ᴨᴀцᴀʜы ᴄᴨᴀᴄуᴛ ᴛᴇбя?', 2.3 },
                        { 'ᴛы ᴛᴇᴨᴇᴘь ᴨᴀцᴀʜ, ᴛы ᴛᴇᴨᴇᴘь ᴄ улицы', 2.8 }
                    },

                    {
                        { ' ᴛы ʙᴇдь ᴨᴏʜяᴧ, ᴋᴛᴏ ʍы? — ᴍы ᴨᴀцᴀʜы', 2.4 }
                    },
                    ...
                    {
                        { 'мой 𝔞𝔢𝔰𝔱𝔥𝔢𝔱𝔦𝔠 сегодня бодр', 1.6 },
                        { 'так что не обессудь ', 2.3 }
                    },

                    {
                        { '𝙁𝙞𝙘𝙠 𝙙𝙞𝙘𝙝 𝙞𝙣𝙨 𝙆𝙣𝙞𝙚, 𝙙𝙪 𝙨𝙘𝙝𝙬𝙪𝙘𝙝𝙩𝙚𝙡.', 1.9 }
                    },

                    {
                        { 'Вы были вызваны на проверку читов, пишите в дискорд -  esoterlc ', 1 }
                    },

                    {
                        { 'λσταλι βьⱡωσ ψσϻ єτι бαλκθνьⱡ', 1 },
                    },

                    {
                        { '𝕓𝕚𝕤𝕥 𝕕𝕦 𝕨𝕚𝕣𝕜𝕝𝕚𝕔𝕙 𝕖𝕚𝕟 𝕒𝕦𝕗𝕣𝕖𝕚ß𝕖𝕣?', 2.1 }
                    },
                    ...
                    {
                        { 'ɪᴄʜ ʜᴇʙʟᴇ ᴅɪᴇ ʟᴄ ᴀᴜs ᴜɴᴅ ғɪᴄᴋ ᴅᴇɪɴᴇ ᴍᴜᴛᴛᴇ.', 2.1 }
                    },

                    {
                        { '𝙾𝙶 𝚜𝚝𝚊𝚝𝚞𝚜. 𝚈𝚘𝚞𝚛e 𝚓𝚞𝚜𝚝 𝚝𝚛𝚊𝚜𝚑', 1.7 },
                    },

                    {
                        { '1', 1 },
                        { 'ΔΣΝϦ ᲼ΩΡΘωΣΛ ᲼Ι ᲼ΝΑΖΑΔ ᲼ΝΣ᲼ ΩΡΙΔΣΤ᲼ ΝΙΚΘΓΔΑ', 2 },
                    },
                    ...
                    {
                        { 'ηöẍöҏöħöė _ - _ ঢ় ü ᑮ ö', 2 },

                    },

                    {
                        { '1', 2 },
                        { 'ќҏöċӹ ųᏰėṫä äҕҏӥќöċä', 2 }
                    },
                    ...
                    {
                        { 'грᴇчκᴀ мᴀᴘтини | мы нᴀ κᴀᴘᴀʜтиʜᴇ', 2 },
                        { 'шᴀшлыκ зᴀᴨᴘᴇᴛили | я нᴀ ᴨᴏзитиʙᴇ', 2.5 }
                    },
                    ...
                    {
                        { '𝖗𝖊𝖎𝖈𝖍𝖌𝖔𝖉𝖟 𝖆𝖗𝖊 𝖙𝖍𝖊 𝖓𝖊𝖜𝖊𝖘𝖙 𝖌𝖔𝖉𝖘', 2 }
                    },

                    {
                        { 'ᴜsᴇʀ ᴀᴅᴅᴇᴅ ᴄʀʏɪɴɢ ᴛᴏ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ ɪᴛ ᴍᴀᴅᴇ ɪᴛ sᴏ ᴍᴜᴄʜ ᴡᴏʀsᴇ', 2.3 }
                    },

                    {
                        { 'ṪℙỀϬɤ६ŢčЯ ႺקØկĤǿ 𝓅Ø₭ᶌᶈᶖŢЬ ǤąШӥШą', 1 },
                        { '1', 1 }
                    },

                    {
                        { 'А23ХЗАД32ХЗАДЗХЦВЙ xA1\xCC\xCC\xCC\xCC\x5E\x8B\x40\x10', 2 }				
                    },

                    {
                        { 'KILLED BY ( ͡° ͜ʖ ͡°) ѕαмѕυηg gαℓαχу ησтє 7 тнαт ιѕ ¢υяяєηтℓу ση fιяє 2016', 2 }
                    },
                    ...
                    {
                        { 'ƳƠṲ ħλƨ ƀƐƐƞ ƖƞṽƖƬƐƊ ƬƠ ƓƠƊƐԼƐƧƧ', 2.11 }
                    },
                    ...
                    {
                        { 'нихуя се я брикнул', 1.60 },
                        { 'хотя не, просто ты нубасик', 2.2 },
                    },

                    {
                        { 'откисай нубяра', 1.20 },
                        { 'в мои god-unhitabble-aa попасть невозможно', 1.6 },
                    },

                    {
                        { 'пошел по комнате дымок╭∩╮(⋋‿⋌ )ᕗ✧', 1.20 },
                        { 'соснул бичара мой хуек (Ψ▼▼)Ψ', 1.20 },
                    },
                    ...
                    {
                        { 'ТыЩ ТыЩ тЫЩ ЧМЫРЬ', 1.60 },
                        { '̲у̲м̲р̲и̲ с̲у̲к̲а̲', 1.8 },
                    },
                    ...
                    {
                        { 'ебал те мать', 1.2 },
                        { 'в толчке под скибиди доп доп', 1.3 },
                    },
                    ...
                    {
                        { 'у россии 3 пути, скит, аестетик, две пизды ', 1.5 },
                    }
                },
                ...
                ['On Death'] = {
                    ...
                    {
                        { 'СУКА ЕБАЛ МАТЬ ДАНИЛЕ', 2 },
                        { 'ОН ЗАЕБАЛ БЕГАТЬ ПО УЛИЦЕ ОРАТЬ ПОМОГИТЕ', 2.3 },
                    },
                    ...
                    {
                        { 'я еду в нижнекамск', 1.20 },
                        { 'чистить даниле ебальник', 1.2},
                    },
...
local function on_player_death(e)
    local me = entity.get_local_player()
    -- Удаляем или комментируем проверку KD
    -- local kd = utils.get_player_kd(me)
    -- if kd ~= nil and kd <= 0.0 then
    --     clear_query()
    --     return
    -- end
    ...
    -- Сработает всегда, когда умерли ВЫ (и это не суицид)
